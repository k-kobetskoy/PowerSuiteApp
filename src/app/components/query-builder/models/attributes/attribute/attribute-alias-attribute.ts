...
export class AttributeAliasAttribute extends NodeAttribute {
    ...
    constructor(node: IQueryNode, validators: AttributeValidators, value?: string, order?: number) {
        ...
        this.attributeDisplayProperties = new AttributeDisplayProperties(this.value$, AttributeNames.attributeAlias, 'Alias', AttributeTreeViewDisplayStyle.alias);
    }
}
