...
export class AttributeNameAttribute extends NodeAttribute {

    constructor(node: IQueryNode, validators: AttributeValidators, value?: string, order?: number) {
        super(node, AttributeNames.attributeName, value);
        this.attributeDisplayProperties = new AttributeDisplayProperties(this.value$, AttributeNames.attributeName, 'AttributeName', AttributeTreeViewDisplayStyle.onlyValue);
    }
}
