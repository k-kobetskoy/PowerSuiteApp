...
export class ConditionAttributeAttribute extends NodeAttribute {

    constructor(node: IQueryNode, validators: AttributeValidators, value?: string, order?: number) {
        super(node, AttributeNames.conditionAttribute, value);
        this.attributeDisplayProperties = new AttributeDisplayProperties(this.value$, AttributeNames.conditionAttribute, 'Attribute', AttributeTreeViewDisplayStyle.onlyValue);
    }
}
