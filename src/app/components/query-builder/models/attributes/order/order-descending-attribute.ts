...
export class OrderDescendingAttribute extends NodeAttribute {
    constructor(node: IQueryNode, validators: AttributeValidators, value?: string, order?: number) {
        super(node, AttributeNames.orderDescending,validators, true,  value);
        this.attributeDisplayProperties = new AttributeDisplayProperties(this.value$, AttributeNames.orderDescending, 'Desc', AttributeTreeViewDisplayStyle.onlyName);
