...
export class OrderAliasAttribute extends NodeAttribute {
    constructor(node: IQueryNode, validators: AttributeValidators, value?: string, order?: number) {
        super(node, AttributeNames.orderAlias,validators, true,  value);
        this.attributeDisplayProperties = new AttributeDisplayProperties(this.value$, AttributeNames.orderAlias, 'OrderAlias', AttributeTreeViewDisplayStyle.alias);
